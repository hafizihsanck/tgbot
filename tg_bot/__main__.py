...
ഞാൻ ഒരു Group Manager Bot ആണ്.വേറുതെ സമയം കളയണ്ട എന്നെ എന്റെ Group ൽ മാത്രമേ ഉപയോഗിക്കാൻ പറ്റുള്ളു.😜
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="Group", url="https://t.me/joinchat/ehFX99SheBI3ZGZl"),  InlineKeyboardButton(text="Channel", url="https://t.me/Moveis_hund") ]]))
